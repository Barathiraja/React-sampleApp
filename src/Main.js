                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav mr-auto">
                            <li className="nav-item active">
                                <a className="nav-link" href="#"><NavLink to="/"><i className="fa fa-home"></i> Home</NavLink> <span className="sr-only">(current)</span></a>

                            </li>


                            <li className="nav-item">
                                <a className="nav-link"><NavLink to="/"> <i className="fa fa-flash"></i> Moments</NavLink></a>
                            </li>

                            <li className="nav-item">
                                <a className="nav-link" ><NavLink to="/"> <i className="fa fa-bell"></i> Notifications</NavLink></a>
                            </li>


                            <li className="nav-item">
                                <a className="nav-link" ><NavLink to="/messages"><i className="fa fa-envelope"></i> messages</NavLink></a>
                            </li>
